...
const PRESET_LOCATIONS = [
  ...
  { name: "Latur", coords: [76.5726, 18.4088], description: "Marathwada, Maharashtra, India" },
  { name: "Osmanabad", coords: [76.0395, 18.1814], description: "Marathwada, Maharashtra, India" }
];
